参见：[Display 示例讲解 — CanMV K230](https://www.kendryte.com/k230_canmv/zh/main/zh/example/media/display.html)
...
如需增加自定义屏幕，可参考[Display Debugger](https://www.kendryte.com/k230_canmv/zh/main/zh/example/media/how_to_add_new_mipi_panel.html)
...
| x     | 起始坐标的 x 值                                                                                              | 输入      |                                                                                                                                      |
| y     | 起始坐标的 y 值                                                                                              | 输入      |                                                                                                                                      |
| layer | 显示到 [指定层](https://www.kendryte.com/k230_canmv/zh/main/zh/api/mpp/K230_CanMV_Display模块API手册.html#layer) | 输入      | 仅支持 `OSD` 层，若需要多层请在[init](#init) 中设置 `osd_num` |
| alpha | 图层混合 alpha                                                                                             | 输入      |                                                                                                                                      |
| flag  | 显示 **[标志](#flag)**                                                                                     | 输入      |                                                                                                                                      |
...
| 参数名称  | 描述                                                                                                                            | 输入 / 输出 | 说明  |
| ----- | ----------------------------------------------------------------------------------------------------------------------------- | ------- | --- |
| layer | 指定获取[layer](#layer) 的宽度,如果不传则表示获取屏幕的分辨率宽度 |         |     |
...
| 参数名称 | 描述                                                         | 输入 / 输出 | 说明 |
| -------- | ------------------------------------------------------------ | ----------- | ---- |
| layer    | 指定获取[layer](#layer) 的高度,如果不传则表示获取屏幕的分辨率高度 |             |      |
