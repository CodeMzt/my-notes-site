...
# GPIO结构
## 片上结构
![../图源/GPIO基本结构.png](../photosource/GPIO基本结构.png)
## 位结构
![../图源/GPIO位结构.png](../photosource/GPIO位结构.png)
## **CubeMX 配置流程**
...
## EXTI基本结构
![../图源/EXTI基本结构.png](../photosource/EXTI基本结构.png)
## AFIO（复用IO口）说明
...
## EXTI框图
![../图源/EXTI框图.png](../photosource/EXTI框图.png)
## **EXTI 配置要点**
