...
![[../photosource/I2C-Bits-Protocol.jpg]]
### 1. 起始（S）和停止（P）条件
...
#### ![I2C指定地址写](../photosource/I2C指定地址写.png)
...
![I2C当前地址读](../photosource/I2C当前地址读.png)
